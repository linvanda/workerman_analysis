...
class Worker
{
     ...
     * 发送restart命令给子进程n秒后，如果子进程仍然未重启则强制kill
     * @var int
     */
    ...
    /**
     * Log file.
     * 日志文件。注意是全局的，说明多个worker实例会写入同一个文件
     * @var mixed
     */
     ...
     * 所有worker实例。注意一个worker实例可能对应多个worker进程
     * @var Worker[]
     */
     ...
     * 所有的worker进程的pid。格式：worker实例id => 该worker实例对应的pid数组
     * @var array
     */
